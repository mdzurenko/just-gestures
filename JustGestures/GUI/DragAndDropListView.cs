		...
		protected override void OnDragDrop(DragEventArgs drgevent)
		{
			...
			if(hoverItem == null)
			{
				...
				for(int i=0; i<data.DragItems.Count; i++)
				{
                    ...
                    if (newItem.Tag != null)
                        newItem.Name = newItem.Tag.ToString();
		...
		protected override void OnDragOver(DragEventArgs drgevent)
		{
			...
			if(base.Items.Count > 0)
			{
				...
				if(hoverItem == null)
				{
					...
					{
                        g.DrawLine(new Pen(m_lineColor, 1), new Point(hoverItem.Bounds.X, hoverItem.Bounds.Y + hoverItem.Bounds.Height), new Point(hoverItem.Bounds.X + this.Bounds.Width, hoverItem.Bounds.Y + hoverItem.Bounds.Height));
					}
					else
					{
                        g.DrawLine(new Pen(m_lineColor, 1), new Point(hoverItem.Bounds.X + hoverItem.Bounds.Width, hoverItem.Bounds.Y), new Point(hoverItem.Bounds.X + hoverItem.Bounds.Width, hoverItem.Bounds.Y + hoverItem.Bounds.Height));
					}
				...
				if(this.View == View.Details || this.View == View.List)
				{
                    g.DrawLine(new Pen(m_lineColor, 1), new Point(hoverItem.Bounds.X, hoverItem.Bounds.Y), new Point(hoverItem.Bounds.X + this.Bounds.Width, hoverItem.Bounds.Y));
				}
				else
				{
                    g.DrawLine(new Pen(m_lineColor, 1), new Point(hoverItem.Bounds.X, hoverItem.Bounds.Y), new Point(hoverItem.Bounds.X, hoverItem.Bounds.Y + hoverItem.Bounds.Height));
				}
